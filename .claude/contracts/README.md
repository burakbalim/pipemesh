...
| 30 | [project-rename.md](project-rename.md) | Adın değişmesi: paketler, proto sözleşmesi, image'lar, depo | ~~Kapatıldı~~ (2026-08-26) — #31 adı sabitledi |
| 31 | [distribution.md](distribution.md) | Paketleri yayınlamak, ve gelen kişinin ilk ekranda ne gördüğü | **Tamam** (2026-08-26) — yayın tag bekliyor |
